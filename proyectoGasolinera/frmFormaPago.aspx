<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmFormaPago.aspx.cs" Inherits="proyectoGasolinera.frmFormaPago" %>
...
<body>
    <form id="form1" runat="server" class="formulario text-center">
        <h2>Creación, actualización y eliminación de formas de pago</h2>
        <div class="form-campos">
            <asp:Label ID="Label1" runat="server" Text="ID"></asp:Label>
            <asp:TextBox ID="txtID" runat="server" Enabled="False" Width="39px"></asp:TextBox>
            <br />
            <asp:Label ID="Label2" runat="server" Text="Forma de pago"></asp:Label>
            <asp:TextBox ID="txtFormaPago" class="form-control" runat="server"></asp:TextBox>
        </div>
        <br />
