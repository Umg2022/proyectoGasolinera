<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProveedor.aspx.cs" Inherits="proyectoGasolinera.frmProveedor" %>
...
<body>
    <form id="form1" runat="server" class="formulario text-center">
        <h2>Creación, actualización y eliminación de proveedores</h2>
        <div class="form-campos">
            <asp:Label ID="Label4" runat="server" Text="ID"></asp:Label>
            <asp:TextBox ID="txtID" runat="server" Enabled="False" Width="42px"></asp:TextBox>
            <br />
